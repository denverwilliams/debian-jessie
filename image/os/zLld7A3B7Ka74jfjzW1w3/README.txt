      Debian GNU/Linux 8.9.0 "Jessie" - Official amd64 NETINST Binary-1
                               20170723-11:47
...
===============
   ...
   The Release Notes for Debian GNU/Linux "jessie" are included on this
   disc in /doc/release-notes/, in several languages. Additional
   translations and updated versions for the Release Notes may be
   available from the Debian web site.
